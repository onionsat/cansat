...
void setup() {
  ...
  for (int i = 0; i < 5; i++) {
      Serial.println(i);
      delay(50);
      Serial0.println("radio set freq 864875000");
      delay(50);
      Serial0.println("radio set bw 250");
      delay(50);
      Serial0.println("radio set pa off");
      delay(50);
      Serial0.println("radio set pwr 14");
      delay(50);
      Serial0.println("radio set sync 35");
      delay(50);
      Serial0.println("radio set sf sf9");
      delay(50);
    }
...
String acceleroRead() {
  ...
  if(-200 <= x <= 200 && -200 <= y <= 200 && -200 <= z <= 200){
...
String bmeRead() {
  ...
  if(100 <= pressure <= 2000 && -50 <= temp <= 80 && 0 <= humid <= 100 && -10000 <= altitude <= 10000){
